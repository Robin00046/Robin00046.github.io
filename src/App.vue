      ...
      <main>
        ...
        <section aria-labelledby="filter-heading">
          ...
          <div class="border-b border-gray-200 bg-white pb-4">
            <div
              class="mx-auto flex max-w-full items-center justify-between px-4 sm:px-6 lg:px-8"
            >
          ...
          <div class="bg-gray-100">
            <div
              class="mx-auto max-w-full px-4 py-3 sm:flex sm:items-center sm:px-6 lg:px-8"
            >
        ...
        <section
          ...
          class="mx-auto max-w-2xl px-4 pb-16 pt-12 sm:px-6 sm:pb-24 sm:pt-16 lg:max-w-full lg:px-8"
        >
